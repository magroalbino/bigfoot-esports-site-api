...
const NewsSystem = () => {
  ...
  return (
    <>
      <Head>
        <title>Sistema de Notícias LoL - Inven Global</title>
        <meta name="description" content="Notícias automáticas e atualizadas sobre League of Legends" />
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 text-white">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mt-12 text-gray-400 text-sm">
            <p>🟢 Sistema ativo - Notícias baseadas no Inven Global</p>
          </div>
        </div>
              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-2">
                    <span className="text-blue-400 font-medium">{selectedNews.source}</span>
                    <span className="text-gray-400">•</span>
                    <span className="text-gray-400">{formatDate(selectedNews.date)}</span>
                  </div>
                  <button 
                    onClick={closeModal}
